...
class PCDModListener(Node):
    ...
    def __init__(self):
        ...
        self.pcd_publisher = self.create_publisher(sensor_msgs.PointCloud2, 'from_ros2_pcd', 10)
    ...
    def listener_callback(self, msg):
        ...
        new_message = sensor_msgs.PointCloud2(header=header, data=msg.data)
        self.pcd_publisher.publish(new_message)
        # new_message = sensor_msgs.PointCloud2(
        #     header=header,
        #     height=1, 
...
def main(args=None):
    ...
    pcd_mod_listener = PCDModListener()
    rclpy.spin(pcd_mod_listener)
    
    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    pcd_mod_listener.destroy_node()
    rclpy.shutdown()
